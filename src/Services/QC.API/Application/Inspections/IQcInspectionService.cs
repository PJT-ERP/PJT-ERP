...
public interface IQcInspectionService
{
    ...
    Task<QcInspectionDto?> ScanAsync(ScanInspectionRequest request, CancellationToken cancellationToken);
    ...
    Task<QcInspectionDto?> UploadFormAsync(Guid id, UploadQcFormRequest request, CancellationToken cancellationToken);
