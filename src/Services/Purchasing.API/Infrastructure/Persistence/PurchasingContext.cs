...
public sealed class PurchasingContext(DbContextOptions<PurchasingContext> options) : DbContext(options), IUnitOfWork
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PurchaseRequest>(builder =>
        {
            ...
            builder.Property(request => request.SupervisorReviewedByUserId).HasColumnName("supervisor_reviewed_by_user_id");
            builder.Property(request => request.SupervisorReviewedAtUtc).HasColumnName("supervisor_reviewed_at_utc");
            builder.Property(request => request.SupervisorRejectionReason).HasColumnName("supervisor_rejection_reason");
